...
class SensorsInterface(QMainWindow):  # Define a class that inherits from QMainWindow
    def __init__(self, shared_data):
        ...
        self.x_label = QLabel("Accel-X: 0.0")  # Label to display Accel X-axis data
        self.y_label = QLabel("Accel-Y: 0.0")  # Label to display Accel Y-axis data
        self.z_label = QLabel("Accel-Z: 0.0")  # Label to display Accel Z-axis data

        self.gyro_x_label = QLabel("Gyro-X: 0.0")  # Label to display Gyro X-axis data
        self.gyro_y_label = QLabel("Gyro-Y: 0.0")  # Label to display Gyro Y-axis data
        self.gyro_z_label = QLabel("Gyro-Z: 0.0")  # Label to display Gyro Z-axis data

        self.mag_x_label = QLabel("Mag-X: 0.0")  # Label to display Mag X-axis data
        self.mag_y_label = QLabel("Mag-Y: 0.0")  # Label to display Mag Y-axis data
        self.mag_z_label = QLabel("Mag-Z: 0.0")  # Label to display Mag Z-axis data
        ...
        self.control_layout.addWidget(self.gyro_x_label)
        self.control_layout.addWidget(self.gyro_y_label)
        self.control_layout.addWidget(self.gyro_z_label)

        self.control_layout.addWidget(self.mag_x_label)
        self.control_layout.addWidget(self.mag_y_label)
        self.control_layout.addWidget(self.mag_z_label)
        ...
        self.gyro_z_curve = self.plot_widget.plot(pen=(255, 255, 0), name="Gyro-Z-axis")  # Create a curve for Gyro Z-axis data with yellow color

        self.mag_x_curve = self.plot_widget.plot(pen=(0, 0, 0), name="Mag-X-axis")  # Create a curve for Mag X-axis data with cyan color
        self.mag_y_curve = self.plot_widget.plot(pen=(127, 255, 0), name="Mag-Y-axis")  # Create a curve for Mag Y-axis data with magenta color
        self.mag_z_curve = self.plot_widget.plot(pen=(255, 140, 0), name="Mag-Z-axis")  # Create a curve for Mag Z-axis data with yellow color
